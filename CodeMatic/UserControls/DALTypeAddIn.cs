...
namespace Codematic.UserControls
{
    ...
    public partial class DALTypeAddIn : UserControl
    {
        ...
        public string AppGuid
        {
            ...
            { 
                //return _guid; 
                if (cmbox_DALType.SelectedValue!=null)
                {
                    return cmbox_DALType.SelectedValue.ToString();
                }
                else
                {
                    return "";
        ...
        {
            if (appguid.Length == 0 && cmbox_DALType.Items.Count > 0)
            {
                DataRow dr = (cmbox_DALType.Items[0] as DataRowView).Row;
                appguid = dr[cmbox_DALType.ValueMember].ToString();                
            }
