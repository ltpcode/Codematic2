...
namespace Codematic.UserControls
{
    ...
    public partial class UcAddInManage : UserControl
    {
        ...
        private bool IsValidPlugin(Type t)
        {
            ...
            {
                if ((theInterface.FullName == "Maticsoft.IBuilder.IBuilderDAL") ||
                    (theInterface.FullName == "Maticsoft.IBuilder.IBuilderDALTran")||
                    (theInterface.FullName == "Maticsoft.IBuilder.IBuilderWeb") ||
                    (theInterface.FullName == "Maticsoft.IBuilder.IBuilderBLL"))
                {
                    ret = true;
                    break;
                }
