...
namespace Codematic
{
	...
	public class LoginOledb : System.Windows.Forms.Form
	{
		...
		public void InitializeComponent()
		{
            ...
            this.toolTip1.SetToolTip(this.txtServer, "请填写数据库文件的完整路径地址。");
            ...
            this.toolTip1.SetToolTip(this.txtConstr, "请填写数据库的ADO.NET连接字符串。");
            // 
            // btn_Ok
            // 
...
//		}
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            try
            {
                openFileDialog1.Title = "选择数据库文件";
                openFileDialog1.Filter = "Access files (*.mdb;*.accdb)|*.mdb;*.accdb|所有文件 (*.*)|*.*";
            ...
            {
                MessageBox.Show("选择数据库文件失败，"+ex.Message);
            }
        }
