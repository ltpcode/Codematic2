...
namespace LTP.BuilderBLLCommRiasy
{
    /// <summary>
    /// 业务层代码组件
    /// </summary>
    public class BuilderBLL : IBuilder.IBuilderBLL
    {
        ...
        public Hashtable Languagelist
        {
            get
            {
                return LTP.CodeHelper.Language.LoadFromCfg("BuilderBLLComm.lan");
            }
        }
        #endregion		
        ...
        {            
            ...
            {
                strclass.AppendSpaceLine(2, "private readonly " + IClass + " dal=" + "DA" + Folder + ".Create" + DALName + "();");
            }
            else
            {
        ...
        public string CreatBLLExists()
        {
            ...
            if (_keys.Count > 0)
            {
                ...
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "return dal.Exists(" + LTP.CodeHelper.CodeCommon.GetFieldstrlist(Keys,false) + ");");
                strclass.AppendSpaceLine(2, "}");
            }            
            return strclass.ToString();
        }
        public string CreatBLLADD()
        {
            ...
            strclass.AppendSpaceLine(2,  "/// </summary>" );
            string strretu = "void";
            if ((DbType == "SQL2000" || DbType == "SQL2005" || DbType == "SQL2008") && (IsHasIdentity))
            {
                strretu = "int ";
            }            
        ...
        public string CreatBLLDelete()
        {
            ...
            strclass.AppendSpaceLine(3, "return dal.Delete(" + LTP.CodeHelper.CodeCommon.GetFieldstrlist(Keys, true) + ");");
            strclass.AppendSpaceLine(2,  "}");
            ...
            if ((LTP.CodeHelper.CodeCommon.HasNoIdentityKey(Keys)) && (LTP.CodeHelper.CodeCommon.GetIdentityKey(Keys) != null))
            {
                ...
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, KeysNullTip);
                strclass.AppendSpaceLine(3, "return dal.Delete(" + LTP.CodeHelper.CodeCommon.GetFieldstrlist(Keys, false) + ");");
                strclass.AppendSpaceLine(2, "}");
            }
        ...
        public string CreatBLLGetModel()
        {
            ...
            strclass.AppendSpaceLine(2,  "{" );
            strclass.AppendSpaceLine(3, KeysNullTip);
            strclass.AppendSpaceLine(3,  "return dal.GetModel(" + LTP.CodeHelper.CodeCommon.GetFieldstrlist(Keys,true) + ");" );
            strclass.AppendSpaceLine(2,  "}");
        ...
        public string CreatBLLGetModelByCache(string ModelName)
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>" );
            strclass.AppendSpaceLine(2, "public " + ModelSpace + " GetModelByCache(" + LTP.CodeHelper.CodeCommon.GetInParameter(Keys,true) + ")");
            strclass.AppendSpaceLine(2, "{" );
            strclass.AppendSpaceLine(3, KeysNullTip);
            string para = "";
            if (Keys.Count > 0)
            {
                para = "+ " + LTP.CodeHelper.CodeCommon.GetFieldstrlistAdd(Keys, true);
            }
            ...
            strclass.AppendSpaceLine(5, "objModel = dal.GetModel(" + LTP.CodeHelper.CodeCommon.GetFieldstrlist(Keys,true) + ");");
        ...
        public string CreatBLLGetList()
        {
            ...
            foreach (ColumnInfo field in Fieldlist)
            {
                ...
                {
                    fieldAuthority=columnName;                    
                }
                if (columnName.IndexOf("_bValid") > 0)//是否生效
                {
                    fieldValid=columnName;                    
                }
            }
